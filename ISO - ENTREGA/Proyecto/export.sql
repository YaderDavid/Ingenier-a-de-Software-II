--------------------------------------------------------
-- Archivo creado  - lunes-agosto-05-2019   
--------------------------------------------------------
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Sequence CO_CARGO_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CO_CARGO_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence CO_CATEGORIA_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CO_CATEGORIA_SEQUENCE"  MINVALUE 1 MAXVALUE 10000000000000 INCREMENT BY 1 START WITH 1001 CACHE 1000 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence CO_EMPLEADO_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CO_EMPLEADO_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 281 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence CO_MONEDA_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CO_MONEDA_SEQUENCE"  MINVALUE 1 MAXVALUE 10000000000000 INCREMENT BY 1 START WITH 1 CACHE 1000 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence CO_ROL_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CO_ROL_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 10 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence IN_MATERIPRIMA_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."IN_MATERIPRIMA_SEQUENCE"  MINVALUE 1 MAXVALUE 10000000000000 INCREMENT BY 1 START WITH 1 CACHE 1000 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence IN_PRODUCTO_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."IN_PRODUCTO_SEQUENCE"  MINVALUE 1 MAXVALUE 10000000000000 INCREMENT BY 1 START WITH 1001 CACHE 1000 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence IN_PROVEEDOR_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."IN_PROVEEDOR_SEQUENCE"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 5001 CACHE 1000 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.CO_CARGO
SET DEFINE OFF;
Insert into SYSTEM.CO_CARGO (ID_CARGO,DESCRIPCION) values (1,'Encargado de inventario');
Insert into SYSTEM.CO_CARGO (ID_CARGO,DESCRIPCION) values (2,'Cajero');
Insert into SYSTEM.CO_CARGO (ID_CARGO,DESCRIPCION) values (3,'Administrador');
REM INSERTING into SYSTEM.CO_EMPLEADO
SET DEFINE OFF;
Insert into SYSTEM.CO_EMPLEADO (ID_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,FECHA_NACIMIENTO,CEDULA,FECHA_INGRESO,SALARIO,USUARIO,"CONTRASEÑA",CORREO,ID_CARGO,IMAGEN) values (235,'Oscar Danilo','Perez  Oporta',to_date('10/11/97','DD/MM/RR'),'001-101197-0013X',to_date('30/06/19','DD/MM/RR'),10000,'X3R0X4','$2b$05$nbNRvkNFd0/MSqKrX4g43OHa81tt4ESe3/C/8.KrohYp.3GAfdCtC','riveramoreira04@gmail.com',1,'dummy');
Insert into SYSTEM.CO_EMPLEADO (ID_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,FECHA_NACIMIENTO,CEDULA,FECHA_INGRESO,SALARIO,USUARIO,"CONTRASEÑA",CORREO,ID_CARGO,IMAGEN) values (272,'Cristopher Mendoza','Sanchez Poveda',to_date('09/03/19','DD/MM/RR'),'001-104390-23432',to_date('16/07/19','DD/MM/RR'),23423432,'sanchez','$2b$05$q/PQAgaPHTTm9l971mkWc.wgnWk/NEl1yyL4rIH8PSW44Poyt.1fa','sanchez@scife.com',1,'dummy');
Insert into SYSTEM.CO_EMPLEADO (ID_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,FECHA_NACIMIENTO,CEDULA,FECHA_INGRESO,SALARIO,USUARIO,"CONTRASEÑA",CORREO,ID_CARGO,IMAGEN) values (273,'Yader David','Castillo Hurtado',to_date('10/03/97','DD/MM/RR'),'001-100397-49304',to_date('09/07/19','DD/MM/RR'),23423432,'castillo','$2b$05$EqUdWWQbV3iPU2azph3c2.48gBVnwFGZTa5n5SCb76amO1BaxHMa6','castillo@scife.com',3,'dummy');
REM INSERTING into SYSTEM.CONF_MODULO
SET DEFINE OFF;
Insert into SYSTEM.CONF_MODULO (ID_MODULO,NOMBRE_MODULO) values (1,'Inventario');
Insert into SYSTEM.CONF_MODULO (ID_MODULO,NOMBRE_MODULO) values (2,'Contabilidad');
Insert into SYSTEM.CONF_MODULO (ID_MODULO,NOMBRE_MODULO) values (3,'Facturación');
Insert into SYSTEM.CONF_MODULO (ID_MODULO,NOMBRE_MODULO) values (4,'Todos');
REM INSERTING into SYSTEM.CONF_MONEDA
SET DEFINE OFF;
Insert into SYSTEM.CONF_MONEDA (ID_MONEDA,NOMBRE_MONEDA,CODIGO_INTERNACIONAL,EQUIVALENCIA_DOLAR) values (1,'Cordoba','NIO',32);
Insert into SYSTEM.CONF_MONEDA (ID_MONEDA,NOMBRE_MONEDA,CODIGO_INTERNACIONAL,EQUIVALENCIA_DOLAR) values (2,'Dolar','USD',1);
REM INSERTING into SYSTEM.CO_PERMISO
SET DEFINE OFF;
Insert into SYSTEM.CO_PERMISO (ID_CARGO,ID_MODULO) values (1,1);
Insert into SYSTEM.CO_PERMISO (ID_CARGO,ID_MODULO) values (2,3);
Insert into SYSTEM.CO_PERMISO (ID_CARGO,ID_MODULO) values (3,4);
...
REM INSERTING into SYSTEM.IN_CATEGORIA
SET DEFINE OFF;
Insert into SYSTEM.IN_CATEGORIA (ID_CATEGORIA,DESCRIPCION_CATEGORIA,NOMBRE_CATEGORIA) values (1,'sds','Pan Simple');
Insert into SYSTEM.IN_CATEGORIA (ID_CATEGORIA,DESCRIPCION_CATEGORIA,NOMBRE_CATEGORIA) values (2,'sd','Pan Dulce');
Insert into SYSTEM.IN_CATEGORIA (ID_CATEGORIA,DESCRIPCION_CATEGORIA,NOMBRE_CATEGORIA) values (3,'sd','Dulces');
Insert into SYSTEM.IN_CATEGORIA (ID_CATEGORIA,DESCRIPCION_CATEGORIA,NOMBRE_CATEGORIA) values (4,'sd','Donas');
REM INSERTING into SYSTEM.IN_CONVERSIONUNIDAD
SET DEFINE OFF;
REM INSERTING into SYSTEM.IN_MATERIAPRIMA
SET DEFINE OFF;
Insert into SYSTEM.IN_MATERIAPRIMA (ID_MATERIAPRIMA,NOMBRE_MATERIA,DESCRIPCION_MATERIA,COSTE,STOCK,STOCK_MINIMO,STOCK_MAXIMO,IMAGEN,ID_CATEGORIA,ID_PROVEEDOR,ID_MONEDA) values (1,'d','d',40,'4.0','4.0','4.0','d',1,1001,1);
REM INSERTING into SYSTEM.IN_PRODUCTO
SET DEFINE OFF;
Insert into SYSTEM.IN_PRODUCTO (CODIGO_BARRA,NOMBRE_PRODUCTO,DESCRIPCION_PRODUCTO,PRECIO,STOCK,STOCK_MAXIMO,STOCK_MINIMO,IMAGEN,ID_MONEDA,ID_CATEGORIA,ID_UNIDADMEDIDA,ESTANTERIA,GAVETA,ID_ENVOLTORIO) values ('1','Bolsa de pan','Bolsa de rico pan mineral',50,'5.0','30.0','1.0','ew',1,1,1,1,1,1);
Insert into SYSTEM.IN_PRODUCTO (CODIGO_BARRA,NOMBRE_PRODUCTO,DESCRIPCION_PRODUCTO,PRECIO,STOCK,STOCK_MAXIMO,STOCK_MINIMO,IMAGEN,ID_MONEDA,ID_CATEGORIA,ID_UNIDADMEDIDA,ESTANTERIA,GAVETA,ID_ENVOLTORIO) values ('2','saasd','scsac',12,'32.0','32.0','32.0','dummy',1,1,1,1,1,1);
Insert into SYSTEM.IN_PRODUCTO (CODIGO_BARRA,NOMBRE_PRODUCTO,DESCRIPCION_PRODUCTO,PRECIO,STOCK,STOCK_MAXIMO,STOCK_MINIMO,IMAGEN,ID_MONEDA,ID_CATEGORIA,ID_UNIDADMEDIDA,ESTANTERIA,GAVETA,ID_ENVOLTORIO) values ('3','prueba','scsacasdsadsad',12,'32.0','32.0','32.0','dummy',1,1,1,1,1,1);
Insert into SYSTEM.IN_PRODUCTO (CODIGO_BARRA,NOMBRE_PRODUCTO,DESCRIPCION_PRODUCTO,PRECIO,STOCK,STOCK_MAXIMO,STOCK_MINIMO,IMAGEN,ID_MONEDA,ID_CATEGORIA,ID_UNIDADMEDIDA,ESTANTERIA,GAVETA,ID_ENVOLTORIO) values ('4','prueba','scsacasdsadsad',123,'32.0','32.0','32.0','dummy',1,1,2,1,1,1);
Insert into SYSTEM.IN_PRODUCTO (CODIGO_BARRA,NOMBRE_PRODUCTO,DESCRIPCION_PRODUCTO,PRECIO,STOCK,STOCK_MAXIMO,STOCK_MINIMO,IMAGEN,ID_MONEDA,ID_CATEGORIA,ID_UNIDADMEDIDA,ESTANTERIA,GAVETA,ID_ENVOLTORIO) values ('5','asdadasds','asdas',123,'3244.0','32.0','32424.0','dummy',2,3,1,1,1,1);
REM INSERTING into SYSTEM.IN_PROVEEDOR
SET DEFINE OFF;
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (2001,'asdas','sdsds','s','prueba','22492912','fulanito prueba','sadsad','sas');
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (1001,'cenix','sdsds','s','prueba','22492912','fulanito prueba','sadsad','as');
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (1002,'asdas','sdsds','s','prueba','22492912','fulanito prueba','sadsad','sas');
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (2002,'panesbonza','asd','s','asd','asdas','sda','asdsa','as');
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (4001,'dsad','asd','n','asdsa','43543454','asdsadsa','sdasdsad','as');
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (3001,'asas','asas','s','sa','sas','assa','assa','as');
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (4002,'dsad','asd','n','asdsa','43543454','asdsadsa','sdasdsad','as');
Insert into SYSTEM.IN_PROVEEDOR (ID_PROVEEDOR,NOMBRE,DESCRIPCION,ES_EMPRESA,DIRECCION,TELEFONO,CONTACTO_PERSONA,CORREO_ELECTRONICO,IMAGEN) values (4003,'dsad','asd','n','asdsa','43543454','asdsadsa','sdasdsad','as');
REM INSERTING into SYSTEM.IN_TIPOUNIDADMEDIDA
SET DEFINE OFF;
Insert into SYSTEM.IN_TIPOUNIDADMEDIDA (ID_TIPO,NOMBRETIPO) values (1,'Masa');
REM INSERTING into SYSTEM.IN_UBICACION
SET DEFINE OFF;
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (1,1);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (1,2);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (1,3);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (2,1);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (2,2);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (2,3);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (3,1);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (3,2);
Insert into SYSTEM.IN_UBICACION (ESTANTERIA,GAVETA) values (3,3);
REM INSERTING into SYSTEM.IN_UNIDADMEDIDA
SET DEFINE OFF;
Insert into SYSTEM.IN_UNIDADMEDIDA (ID_UNIDADMEDIDA,NOMBREUNIDADMEDIDA,ID_TIPO) values (1,'Unidad',1);
Insert into SYSTEM.IN_UNIDADMEDIDA (ID_UNIDADMEDIDA,NOMBREUNIDADMEDIDA,ID_TIPO) values (2,'Libra',1);
Insert into SYSTEM.IN_UNIDADMEDIDA (ID_UNIDADMEDIDA,NOMBREUNIDADMEDIDA,ID_TIPO) values (3,'Onzas',1);
...
/
--------------------------------------------------------
--  DDL for Package CONTABILIDAD
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."CONTABILIDAD" IS

     PROCEDURE CO_EMPLEADO_CREATE (
         P_ID_CARGO IN CO_EMPLEADO.ID_CARGO%TYPE
        ,P_CORREO IN CO_EMPLEADO.CORREO%TYPE
        ,P_CONTRASEÑA IN CO_EMPLEADO.CONTRASEÑA%TYPE
        ,P_NOMBRE_EMPLEADO IN CO_EMPLEADO.NOMBRE_EMPLEADO%TYPE
